...
<select class="mdl-textfield__input mdl-js-textfield mdl-cell mdl-cell--3-col" name="funcionario_id">
  <option value="">Selecione o funcionário</option>
  @foreach($cargos as $cargo)
    <optgroup label="{{ $cargo->descricao }}">
...
<div class="mdl-textfield mdl-js-textfield mdl-cell mdl-cell--5-col">
  ...
  {!! Form::date('dataLancamento', null, ['id'=>'dataLancamentoF', 'min'=>'2000-01-01','class'=>"mdl-textfield__input", 'pattern'=>"-?[0-9]*(\.[0-9]+)?"]) !!}
</div>

<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--2-col">
  {!! Form::text('valorSalario', null, ['id'=>'valorSalario', 'onkeypress'=>'mascara(this,moeda)','class'=>"mdl-textfield__input"]) !!}
  {!! Form::label('valorSalario', 'Valor do salário R$', ['class'=>"mdl-textfield__label"]) !!}
</div>
...
document.getElementById('dataLancamentoF').valueAsDate = new Date();
