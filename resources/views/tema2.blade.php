...
<body>
  <header>
    <nav class="top-nav">
      <div class="container">
        <div class="nav-wrapper"><a class="page-title">ffffffffffffffffffffffffffffffffffffffffff</a></div>
      </div>
    </nav>
    ...
    <ul id="nav-mobile" class="side-nav fixed" style="transform: translateX(0%);">
      <li class="logo"><a id="logo-container" href="http://materializecss.com/" class="brand-logo">
        ...
        <li class="bold"><a href="showcase.html" class="waves-effect waves-teal">Mostruário</a></li>
        <li class="bold"><a href="themes.html" class="waves-effect waves-teal">Themes</a></li>
      </ul>
    </header>


    <!-- <div class="card-panel teal lighten-2 "> @yield('title_page') </div> -->
